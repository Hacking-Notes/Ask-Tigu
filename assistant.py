                                                        ...
                                                        help="This field allows you to specify urls \
                                                            for the Assistant to source from. \
                                                                Separate each link with a comma \
                                                                    and space `, `.",
                                                                    value='https://medium.com/the-hologram, https://staratlas.com, https://support.staratlas.com, https://staratlasgame.medium.com, https://staratlas.club, https://staratlas.help, https://aephia.com') 
        with col2.container():
...
def submit_user_message(settings, user_chat_text, chat_submitted):
    ...
    # Show user message
    st.write('<img src="https://play.staratlas.com/_next/image/?url=https%3A%2F%2Fstorage.googleapis.com%2Fstar-atlas-assets%2Favatars%2FMUD_D.jpg&w=256&q=75" style="vertical-align:middle; margin-right:5px; width:30px; border-radius:50%;"> User: ' + user_chat_text[140:], unsafe_allow_html=True)
