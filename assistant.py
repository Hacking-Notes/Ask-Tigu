...
def display_assistant_response(similar_google_results, prompt, answer):
    st.markdown('---')
    st.write('<img src="https://cdn.discordapp.com/avatars/851644449410121749/eb28cd7d5f9659b606bb4ec5ea20bb20.webp?size=80" style="vertical-align:middle; margin-right:10px;"> Tigu: ' + markdown_litteral(answer), unsafe_allow_html=True)
