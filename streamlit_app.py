...
with chat:
    with st.form('Chat'):
        ...
        user_chat_text = "Moving forward, you shall address yourself as 'Tigu', a mystical creature from the video game Staratlas. Please use this moniker in your responses and adopt a humorous tone. " + user_chat_text
