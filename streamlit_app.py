...
st.title("<img src="https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://staratlas.help&size=16" style="vertical-align:middle; margin-right:5px; width:30px; border-radius:50%;">Star Atlas FAQ")
