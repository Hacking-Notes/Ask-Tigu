...
with col1:
    ...
    st.markdown(f'<a href="{url}"><button style="padding: 7.5px 40px; border: 1px solid #404046; border-radius: 8px; background-color: #222129; font-family: compact,sans-serif; font-size: 14px; text-align: center; cursor: pointer; color: #ffffff;">🛒 ---> Star Atlas Market Place</button></a>', unsafe_allow_html=True)
with col2:
    st.container()
with col3:
    st.container()
